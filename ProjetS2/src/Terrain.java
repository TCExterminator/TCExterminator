...
public class Terrain {
	...
	//m騁hode servant � tester la collision entre une Entite est une case
		public void collision(){
			//� coder
		}
		
		//m騁hode servant � r馗up駻er un type de case � une position donn馥 pass� en param黎re
		...
		//m騁hode servant � supprimer une entite et retourne un boolean 
